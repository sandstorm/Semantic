 ...
 * @covers SandstormMedia\Semantic\Core\Rdf\Concept\NamedNode
 */
class NamedNodeTest extends \TYPO3\FLOW3\Tests\UnitTestCase {
	...
	public function conversionToIriIsAttemptedUsingInjectedProfile() {
		$namedNode = $this->getAccessibleMock('SandstormMedia\Semantic\Core\Rdf\Concept\NamedNode', array('dummy'), array('my:curie'));
		$profile = $this->getMock('SandstormMedia\Semantic\Core\Rdf\Environment\ProfileInterface');
	...
	public function ifCurieCouldNotBeResolvedIriIsUsedWithoutModification() {
		$namedNode = $this->getAccessibleMock('SandstormMedia\Semantic\Core\Rdf\Concept\NamedNode', array('dummy'), array('http://my.iri'));
		$profile = $this->getMock('SandstormMedia\Semantic\Core\Rdf\Environment\ProfileInterface');
		$namedNode->_set('profile', $profile);
